    ...
    for category in categories.values():
        for key, value in category.items():
            ...
            if value['format'][0] == True:
                ...
                elif value['format'][-1] == 'agent_id':
                    data = request_to_api(value['link'],domain,format=value['format'][0],format_id=value['format'][-1], format_info=__AGENT_ID, key=key)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--Base','-b', type=str,help='Agrege la ruta a la base de datos de esta manera \n"postgresql://usuario:clave@host/nombre_base_de_datos"')
